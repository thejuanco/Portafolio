    ...
    <section id="contact" className="py-28">
      <div className="space-y-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="flex items-center font-medium bg-gray-900 text-slate-200 py-2 px-4 rounded-full hover:bg-gray-800">
            ...
            <Link 
              ...
              target="_blank"
            >
              <img src="/images/linkedin.png" alt="Descripción de la imagen" className="w-7 h-7"/>
                LinkedIn
            </Link>
        </div>
      </div>
